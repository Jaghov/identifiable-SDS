...
from models.VariationalSNLDS_NF import FlowSNLDS
...
for restart_num in range(3):
    ...
    model = FlowSNLDS(dim_obs, dim_latent, 64, num_states, encoder_type='flow', device=device, annealing=False, inference='alpha', beta=0)
